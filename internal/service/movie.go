...
func (s *MovieService) GetAll(ctx context.Context) ([]domain.Movie, *utils.Error) {
...
func (s *MovieService) SearchByName(ctx context.Context, name string) ([]domain.Movie, *utils.Error) {
	return s.repo.SearchByName(ctx, name)
}

func (s *MovieService) GetByGenres(ctx context.Context, genreIds []string) ([]domain.Movie, *utils.Error) {

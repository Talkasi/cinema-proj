...
func (s *SeatService) GetAll(ctx context.Context) ([]domain.Seat, *utils.Error) {
...
func (s *SeatService) Update(ctx context.Context, seat domain.Seat) (domain.Seat, *utils.Error) {
...
func (s *SeatService) GetByHall(ctx context.Context, hallId string) ([]domain.Seat, *utils.Error) {

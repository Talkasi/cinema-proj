...
type UserRepository interface {
	...
	Update(ctx context.Context, id string, u domain.User) (domain.User, *utils.Error)
...
type GenreRepository interface {
	...
	Update(ctx context.Context, id string, g domain.Genre) (domain.Genre, *utils.Error)
	Delete(ctx context.Context, id string) *utils.Error
...
type HallRepository interface {
	...
	Update(ctx context.Context, id string, h domain.Hall) (domain.Hall, *utils.Error)
	Delete(ctx context.Context, id string) *utils.Error
...
type MovieShowRepository interface {
	...
	Update(ctx context.Context, id string, m domain.MovieShow) (domain.MovieShow, *utils.Error)
	Delete(ctx context.Context, id string) *utils.Error
...
type MovieRepository interface {
	...
	Update(ctx context.Context, id string, m domain.Movie) (domain.Movie, *utils.Error)
	Delete(ctx context.Context, id string) *utils.Error
...
type ScreenTypeRepository interface {
	...
	Update(ctx context.Context, id string, t domain.ScreenType) (domain.ScreenType, *utils.Error)
	Delete(ctx context.Context, id string) *utils.Error
...
type SeatTypeRepository interface {
	...
	Update(ctx context.Context, id string, t domain.SeatType) (domain.SeatType, *utils.Error)
	Delete(ctx context.Context, id string) *utils.Error
...
type SeatRepository interface {
	...
	Update(ctx context.Context, id string, s domain.Seat) (domain.Seat, *utils.Error)
	Delete(ctx context.Context, id string) *utils.Error
...
type TicketRepository interface {
	...
	Update(ctx context.Context, id string, ticket domain.Ticket) (domain.Ticket, *utils.Error)
	Delete(ctx context.Context, id string) *utils.Error
}

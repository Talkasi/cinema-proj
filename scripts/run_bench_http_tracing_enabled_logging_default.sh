...
# Запускает BenchmarkHTTPTracingEnabledLoggingDefault 20 раз (можно переопределить BENCH_COUNT)
BENCH_NAME="BenchmarkHTTPTracingEnabledLoggingDefault"
LABEL="http-tracing-enabled-log-default"

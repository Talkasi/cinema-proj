...
# Запускает BenchmarkHTTPTracingEnabledLoggingExtended 20 раз (можно переопределить BENCH_COUNT)
BENCH_NAME="BenchmarkHTTPTracingEnabledLoggingExtended"
LABEL="http-tracing-enabled-log-extended"
